...
#define IO_RA2_SetPushPull()    do { ODCONAbits.ODA2 = 1; } while(0)
#define IO_RA2_SetOpenDrain()   do { ODCONAbits.ODA2 = 0; } while(0)
...
#define IO_RA4_SetPushPull()    do { ODCONAbits.ODA4 = 1; } while(0)
#define IO_RA4_SetOpenDrain()   do { ODCONAbits.ODA4 = 0; } while(0)
...
#define IO_RB6_SetPushPull()    do { ODCONBbits.ODB6 = 1; } while(0)
#define IO_RB6_SetOpenDrain()   do { ODCONBbits.ODB6 = 0; } while(0)
...
#define IO_RB7_SetPushPull()    do { ODCONBbits.ODB7 = 1; } while(0)
#define IO_RB7_SetOpenDrain()   do { ODCONBbits.ODB7 = 0; } while(0)
...
#define motor       LATB7
#define redLed      LATC4
#define greenLed    LATC5
#define IrLed       LATB6
#define OptoLed     LATA5
#define photoTr     RA2
#define OptoOc      RA4
#define BattVref    RC1
